# Claude Code Instructions — NRP Node Labeler

## Label Nodes Workflow

When the user provides a list of nodes to label, follow the steps below to check and update `node-institution.csv`.

The Claude Code skill at `.claude/skills/label-nodes` contains the full instructions. Invoke it with `/label-nodes`.
